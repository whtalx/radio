...
export default function Info({ bitrate, channels, type, favourite, samplerate }) {
  ...
  return (
    <Wrapper viewBox="0 0 105 18">
      ...
      <g transform="translate(21,0)" opacity={ opacity(bitrate) }>
        <mask id="bitrate">
      ...
      <g transform="translate(67,0)" opacity={ opacity(samplerate) }>
        <mask id="samplerate">
          <rect x="0" y="0" width="22" height="7" />
          <text x="11" y="6" textAnchor="middle" fill="black">
      ...
      <g transform="translate(94,0)" opacity={ opacity(favourite) }>
        <path d="M0.5 3C0.5 4 3 6 4.5 7C6 6 8.5 4 8.5 3C9 -0 5.5 -0 4.5 1.5C3.5 -0 0 0 0.5 3Z" />
      </g>
      <text x="0" y="17">mode:</text>
      <g transform="translate(21, 11)" opacity={ opacity(channels) }>
        <mask id="mode">
      ...
      <g transform="translate(79, 11)" opacity={ opacity(type) }>
        <mask id="type">
